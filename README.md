...
<p>🔗 <strong>Directory Link</strong>: <a href="https://github.com/Rohit-Pakhre09/Mini-JavaScript-Projects/tree/main/Calculator">https://github.com/Rohit-Pakhre09/Mini-JavaScript-Projects/tree/main/Calculator</a></p>
...
<h1>📃 Modern To-Do App</h1> <img src="https://github.com/Rohit-Pakhre09/Mini-JavaScript-Projects/blob/2e0a9089f0739febfe6a7d3f29d2e51d5a4b55aa/Todo%20App/Assets/Todo%20App.png" alt="Modern To-Do App Screenshot"> <p>🔗 <strong>Directory Link</strong>: <a href="https://github.com/Rohit-Pakhre09/Mini-JavaScript-Projects/tree/main/Todo%20App">https://github.com/Rohit-Pakhre09/Mini-JavaScript-Projects/tree/main/Todo%20App</a></p> <p>This is a feature-rich and visually refined <strong>To-Do List Application</strong> built using <strong>HTML</strong>, <strong>CSS</strong>, and <strong>JavaScript</strong>. Designed for efficiency and ease of use, the app supports full <strong>CRUD (Create, Read, Update, Delete)</strong> operations with real-time interactivity. Whether you’re organizing your daily tasks or managing a project checklist, this app provides a reliable and delightful user experience across all devices.</p> <p><strong>✨ Features</strong><br> 🆕 <strong>Create Tasks</strong>: Add new tasks instantly with a clear input field and one-click action.<br> 📋 <strong>View Task List</strong>: Easily visualize all your tasks in a clean, scrollable list.<br> ✏️ <strong>Edit Tasks</strong>: Modify any existing task directly with a smooth inline editing experience.<br> 🗑️ <strong>Delete Tasks</strong>: Remove tasks effortlessly using a dedicated delete button.<br> 📦 <strong>Local Storage Integration</strong>: Tasks persist even after refreshing or reopening the browser.<br>  🎯 <strong>Interactive Feedback</strong>: Real-time input handling and clear visual feedback for every action.<br> ✅ <strong>Status Indicators</strong>: Mark tasks as completed with visual distinction and toggling options.</p> <p><strong>📁 Technologies Used</strong><br> 💡 <strong>HTML5</strong> – For semantic structure and input elements.<br> 🎨 <strong>CSS3</strong> – For beautiful styling, animations, responsiveness, and mobile support.<br> ⚙️ <strong>JavaScript (ES6+)</strong> – For full CRUD logic, real-time updates, DOM manipulation, and local storage handling.</p> <hr>

<h1>🕒 Digital Clock</h1>
<img src="https://github.com/Rohit-Pakhre09/Mini-JavaScript-Projects/blob/4a35c56ecc3b3515c7e337c18960b485567f3947/Digital%20Clock/Assets/Digital%20Clock.png">
...
<p>This elegant and efficient <strong>Seconds Converter Application</strong> allows users to seamlessly convert seconds into hours and minutes using a <strong>modern and user-friendly interface</strong>. Built with <strong>HTML</strong>, <strong>CSS</strong>, and <strong>JavaScript</strong>, this tool is perfect for time calculations in a clean and responsive layout.</p>
