...
<h1>🧠 Quiz App</h1> <img src="https://github.com/Rohit-Pakhre09/Mini-JavaScript-Projects/blob/5e485b905e0bdbafaae9ec137848acf9f84de869/Quiz%20App/Assets/Quiz%20App.png" alt="Quiz App Screenshot"> <h3>🔗 Directory Link: <a href="https://github.com/Rohit-Pakhre09/Mini-JavaScript-Projects/tree/main/Quiz%20App">https://github.com/Rohit-Pakhre09/Mini-JavaScript-Projects/tree/main/Quiz%20App</a></h3> <p> This is a modern and interactive <strong>Quiz Web App</strong> developed using <strong>HTML</strong>, <strong>CSS</strong>, and <strong>JavaScript</strong>. Designed with a focus on user engagement and real-time feedback, the app features a modern UI, integrated countdown timer, instant answer validation, and a smooth, seamless quiz-taking experience. Ideal for practicing multiple-choice questions in a timed environment. </p>
<p><strong>✨ Key Features</strong></p> <p> ✅ <strong>5 Dynamic Questions</strong>: The quiz includes a set of 5 well-structured multiple-choice questions.<br> ⏳ <strong>60-Second Countdown per Question</strong>: A timer runs for each question to simulate a real exam environment and test time management.<br> ✅ <strong>Instant Answer Validation</strong>: As soon as an option is clicked, the app visually highlights the correct and incorrect answers using color feedback (green for correct, red for incorrect).<br> 🎯 <strong>Score Tracking</strong>: Tracks your total score throughout the quiz and displays the final result at the end.<br> 🎨 <strong>Modern, Clean UI</strong>: Designed with clean typography, responsive layout, subtle animations, and vibrant color feedback to ensure an intuitive and professional user experience.<br> </p>
<p><strong>📁 Technologies Used</strong></p> <p> <strong>HTML5</strong> – Semantic structure for rendering questions, options, timer, and results.<br> <strong>CSS3</strong> – Styling with transitions and feedback animations for correct/incorrect answers.<br> <strong>JavaScript (ES6+)</strong> – Core logic handling the quiz timer, option selection, scoring system, and DOM manipulation.<br> </p>
<hr>
